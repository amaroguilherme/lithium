...
- `preference` — how they want the work done, or what they value. "Prefiro entender o
  mecanismo antes de ver a evidência."
- `constraint` — a hard limit. "Não considerar nada que exija monitoramento sérico."
- `context` — a fact about the case the literature cannot supply. "Já tentei a opção X
  e tive um efeito adverso."
- `fact` — anything else durable and specific about them or the project's scope.

## Do not remember

- questions, however interesting
- speculation, hypotheses, thinking out loud
- anything the system already knows from the literature
- passing reactions ("interessante", "faz sentido")
- restatements of something already in the memory list below
- transient state — what they are doing today, what they just read
